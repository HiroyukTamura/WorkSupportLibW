...
/**
 * RecordFragmentから呼ばれる。 todo
 */
// TODO: 2017/11/07  このRecordRVAdapterは使われていないのでは？ 確認したらこのtodo を消せ 青コメはコメントアウト場所
...
//            }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R2.id.radio) SmoothCheckBox radio;
//        FrameLayout frame;
//        RadioButton radio2;
//        RadioGroup radioG;
        @BindView(R2.id.value) TextView value;
        @BindView(R2.id.time) TextView time;
        @BindView(R2.id.time_card) CardView cardView;
        ViewHolder(View v){
            super(v);
