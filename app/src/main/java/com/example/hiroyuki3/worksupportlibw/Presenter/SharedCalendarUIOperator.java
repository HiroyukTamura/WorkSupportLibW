...
import com.example.hiroyuki3.worksupportlibw.Adapters.CalendarRVAdapter;
...
public class SharedCalendarUIOperator implements ValueEventListener, OnDateSelectedListener{
    ...
    @BindView(R2.id.calendarView) MaterialCalendarView mcv;
    @BindView(R2.id.recycler) RecyclerView rv;
